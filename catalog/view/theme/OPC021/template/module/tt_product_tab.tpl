<div class="container ttproduct-main">
...
<h4 class="tthometab-subtitle"><?php echo $heading_subtitle; ?></h4>
</div>
<div id="TTPTab-<?php echo $module; ?>" class="tab-box-heading">
	<ul class="nav nav-tabs">
	<?php if($featured_products){ ?>
	  <li><a href="#tab-featured-<?php echo $module; ?>" data-toggle="tab"><h3><?php echo $tab_featured; ?></h3></a></li>
	<?php } ?>
	<?php if($latest_products){ ?>
	  <li><a href="#tab-latest-<?php echo $module; ?>" data-toggle="tab"><h3><?php echo $tab_latest; ?></h3></a></li>
	<?php } ?>
	<?php if($bestseller_products){ ?>
	  <li><a href="#tab-bestseller-<?php echo $module; ?>" data-toggle="tab"><h3><?php echo $tab_bestseller; ?></h3></a></li>
	<?php } ?>
	<?php if($special_products){ ?>
	  <li><a href="#tab-special-<?php echo $module; ?>" data-toggle="tab"><h3><?php echo $tab_special; ?></h3></a></li>
	<?php } ?>
	</ul>
</div>
  ...
  <div id="tab-featured-<?php echo $module; ?>" class="tab-pane">
    <div class="products-carousel">
      ...
      <div class="button-group">
        <button class="btn-cart" type="button" data-toggle="tooltip" title="<?php echo $button_cart; ?>" onclick="cart.add('<?php echo $product['product_id']; ?>');"><i class="fa fa-shopping-cart"></i>
    ...
    <div class="products-carousel">
      ...
      <div class="caption">
	   <h4><a href="<?php echo $product['href']; ?>"><?php echo $product['name']; ?></a></h4>
        ...
        <div class="button-group">
        <button class="btn-cart" type="button" data-toggle="tooltip" title="<?php echo $button_cart; ?>" onclick="cart.add('<?php echo $product['product_id']; ?>');"><i class="fa fa-shopping-cart"></i> <span class="hidden-xs hidden-sm hidden-md"><?php echo $button_cart; ?></span>
		</button>
        <button class="btn-wishlist" data-toggle="tooltip" title="<?php echo $button_wishlist; ?>" onclick="wishlist.add('<?php echo $product['product_id']; ?>');"><i class="fa fa-heart"></i>
		</button>
        <button class="btn-compare" data-toggle="tooltip" title="<?php echo $button_compare; ?>" onclick="compare.add('<?php echo $product['product_id']; ?>');"><i class="fa fa-exchange"></i>
