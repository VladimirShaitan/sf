  ...
  <?php foreach ($products as $product) { ?>
    <div class="product-layouts">
	  ...
	  <div class="thumb-description">
        ...
        <button class="btn-cart" title="<?php echo $button_cart; ?>" data-toggle="tooltip" type="button" onclick="cart.add('<?php echo $product['product_id']; ?>');"><i class="fa fa-shopping-cart"></i> <span class="hidden-xs hidden-sm hidden-md"><?php echo $button_cart; ?></span>
		</button>
