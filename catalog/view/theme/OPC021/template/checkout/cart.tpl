...
<!--
                <td class="text-left"><div class="input-group btn-block" style="max-width: 200px;">
                    ...
                    <button type="submit" data-toggle="tooltip" title="<?php echo $button_update; ?>" class="btn btn-primary main"><i class="fa fa-refresh"></i></button>
...
-->
<!--
                <td class="text-right unit-price"><?php echo $product['price']; ?></td>
...
-->
	  ...
	  <div class="buttons">
        <div class="pull-left"><a href="<?php echo $continue; ?>" class="btn btn-default cnt"><?php echo $button_shopping; ?></a></div>
        <div class="pull-right"><a href="<?php echo $checkout; ?>" class="btn btn-primary checkout"><?php echo $button_checkout; ?></a></div>
      </div>
