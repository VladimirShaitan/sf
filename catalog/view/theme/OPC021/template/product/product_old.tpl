  ...
  <div class="row"><?php echo $column_left; ?>
    ...
    <div id="content" class="<?php echo $class; ?>"><?php echo $content_top; ?>
	  ...
	  <div class="row">
		...
		<?php $class = 'col-sm-7'; ?>
		<?php } else { ?>
		<?php $class = 'col-xs-12 col-sm-5 col-md-6'; ?>
		<?php } ?>
        <div class="<?php echo $class; ?> product-images">
		  ...
		  <!-- Product Image thumbnails START -->
            ...
            <?php if ($thumb) { ?>
            <div class="product-image"><a class="thumbnail" href="<?php echo $popup; ?>" title="<?php echo $heading_title; ?>"><img src="<?php echo $thumb; ?>" title="<?php echo $heading_title; ?>" alt="<?php echo $heading_title; ?>" /><?php if ($special) { ?> <span class="product-sale-icon">Sale</span> <?php } ?></a></div>
            <?php } ?>
...
<?php } ?>
		...
		<?php $class = 'col-sm-5'; ?>
		<?php } else { ?>
		<?php $class = 'col-xs-12 col-sm-7 col-md-6'; ?>
		<?php } ?>
		<div class="<?php echo $class; ?> product-details">
          ...
          <table class="product-info">
            ...
            <tr><td><?php echo $text_stock; ?></td><td class="product-info-value"><?php echo $stock; ?></td></tr>
              ...
              <a class="product-total-review" href="" onclick="$('a[href=\'#tab-review\']').trigger('click'); return false;"><i class="fa fa-comment"></i><?php echo $reviews; ?></a> 
 ...
 <?php echo $text_write; ?></a>
		  ...
		  <div class="btn-group">
            <button class="btn btn-default product-btn-wishlist" type="button" onclick="wishlist.add('<?php echo $product_id; ?>');"><i class="fa fa-heart"></i> <?php echo $button_wishlist; ?></button>
            <button class="btn btn-default product-btn-compare" type="button" onclick="compare.add('<?php echo $product_id; ?>');"><i class="fa fa-exchange"></i> <?php echo $button_compare; ?></button>
          </div>
	...
	<?php echo $column_right; ?>
	  ...
	  <div class="related-carousel products-list col-sm-12">
        ...
        <button class="btn-cart" type="button" title="<?php echo $button_cart; ?>" data-toggle="tooltip" onclick="cart.add('<?php echo $product['product_id']; ?>');"><i class="fa fa-shopping-cart"></i> <span class="hidden-xs hidden-sm hidden-md"><?php echo $button_cart; ?></span>
		</button>
