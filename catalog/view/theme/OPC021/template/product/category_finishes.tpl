...
<div class="container product-category">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-3 col-sm-4">
                        <div class="class-list-item clearfix">
                            ...
                            <a class="four_in_row" href="<?php echo $category['href']; ?>">
	...
	<a href="<?php echo $product['thumb']; ?>" title="<?php echo $product['name']; ?> - (<?php echo $product['stock']; ?>)" style="width:193px;height:125px;" data-source="">
...
-->
                            ...
                            <div class="fin_name text-center">
                                ...
                                <span class="h5">(<?php echo $product['stock']; ?>)</span>
                            </div>
                        </div>
