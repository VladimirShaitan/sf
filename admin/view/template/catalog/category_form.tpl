              ...
              <div class="tab-content">
                ...
                <div class="tab-pane" id="language<?php echo $language['language_id']; ?>">
                  ...
                  <div class="form-group">
                   ...
                   <div class="form-group">
                    <label class="col-sm-2 control-label" for="input-description<?php echo $language['language_id']; ?>">Choose category type</label>
                    <div class="col-sm-10">
                      <select type="text" name="category_description[<?php echo $language['language_id']; ?>][category_type]" id="input-description<?php echo $language['language_id']; ?>" class="form-control">
                          <option value="product" <?php if($category_description[$language['language_id']]['category_type'] == 'product'){echo 'selected';} ?>>Row Category</option>
                           <option value="finishes" <?php if($category_description[$language['language_id']]['category_type'] == 'finishes'){echo 'selected';} ?>>Grid category</option>
                           <option value="collection" <?php if($category_description[$language['language_id']]['category_type'] == 'finishes'){echo 'selected';} ?>>2 per row</option>
                        </select>
                    </div>
                  </div>
