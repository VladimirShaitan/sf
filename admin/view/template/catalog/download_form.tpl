    ...
    <div class="panel panel-default">
      ...
      <div class="panel-body">
        <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-download" class="form-horizontal">
         ...
         <div class="form-group">
            <label class="col-sm-2 control-label" for="input-mask"><span data-toggle="tooltip" title="Use file manager">Image</span></label>
            <div class="col-sm-10">
            <?php if($image){ ?>
             <a href="" id="thumb-image" data-toggle="image" class="img-thumbnail" style="width: 100px; height: 100px; position: relative; overflow: hidden; padding: 5px">
                 <img src="<?php echo IMG_PATH . $image; ?>" alt="" style="position: absolute; top: 50%; transform: translateY(-50%);
                 left: 0" title="" class="img-responsive" data-placeholder="<?php echo $placeholder; ?>" />
             </a>
             <input type="hidden" name="image" value="<?php echo $image; ?>" id="input-image" /> 
             <?php } else { ?>
             <a href="" id="thumb-image" data-toggle="image" class="img-thumbnail">Choose image</a>
             <input type="text" name="image" value="<?php echo $image; ?>" id="input-image" /> 
             <?php } ?>
            </div>
          </div>
