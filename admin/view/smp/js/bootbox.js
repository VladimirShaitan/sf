...
//  "use strict";
  ...
  var appendTo = $$('<div>').addClass('seo-mega-pack').prependTo("body");
  ...
  exports.dialog = function(options) {
    ...
    */
    ...
    dialog.on("shown.bs.modal", function() {
	  ...
	  $$(window).bind('resize.bootbox', resize);
    ...
    dialog.on("escape.close.bb", function(e) {
		$$(window).unbind('resize.bootbox', resize);
