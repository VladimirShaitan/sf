...
//heading
    ...
    $_['text_edit'] = 'Edit Simple One Page Checkout settings';
...
//payment_method
    ...
    $_['callout_payment_payment_popup'] = '<h3>Turn on or off the Popup window for each payment</h3><p>Below you can turn on or off the popup window for each payment. Every payment method has its specific conditions. In some cases we advise to use a popup window for a payment that has a lot of input feilds which you do not want to update every time you edit your address fields. Since opencart requires you to update the payment block, you can use this option to make the process more user-friendly by providing a popup window with the payment step as the final step. Also in some cases you can use this option to validate the payment method to work with SOPC as a compatibility solution.</p>';
...
//design
    $_['entry_design_theme'] = 'Select theme for SOPC';
