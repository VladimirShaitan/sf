	...
	public function index() { 
		...
		foreach ($results as $result) {
			...
			$data['albums'][] = array(
				...
				'href' => $this->url->link('opencart_gallery/album/edit', 'token=' . $this->session->data['token'] . '&album_id=' . $result['album_id'] , 'SSL')
			);
		}
		...
		foreach ($results as $result) {
			...
			$data['videos'][] = array(
				'name'        => $result['name'],
				'viewed'      => $result['viewed'],
				'href' => $this->url->link('opencart_gallery/video/edit', 'token=' . $this->session->data['token'] . '&video_id=' . $result['video_id'] , 'SSL')
			);
		}
