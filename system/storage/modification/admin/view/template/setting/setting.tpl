...
<!--                  <input type="text" name="config_geocode" value="<?php echo $config_geocode; ?>" placeholder="<?php echo $entry_geocode; ?>" id="input-geocode" class="form-control" />-->
                    <textarea name="config_geocode" placeholder="<?php echo $entry_geocode; ?>" rows="5" id="input-geocode" class="form-control"><?php echo $config_geocode; ?></textarea>
                </div>
              </div>
              <div class="form-group required">
...
<!--              Copyright-->
               <div class="form-group required">
                <label class="col-sm-2 control-label" for="input-copiright">Copyright</label>
                <div class="col-sm-10">
                  <input type="text" name="config_coryright" value="<?php echo $config_coryright; ?>" placeholder="Copyright" id="input-copuright" class="form-control" />
                </div>
              </div>
<!--              Copyright-->
              <div class="form-group required">
                <label class="col-sm-2 control-label" for=""><span data-toggle="tooltip" data-container="#tab-general" title="width and height for category menu items in top main menu">W & H menu imgs</span></label>
                <div class="col-sm-10">
                <!--New fields-->
                <input type="text" name="config_telephone2" value="<?php echo $config_telephone2; ?>" placeholder="width" id="input-telephone2" class="form-control " />
                <br>
                <input type="text" name="config_telephone3" value="<?php echo $config_telephone3; ?>" placeholder="height" id="input-telephone3" class="form-control" />                  
                  <!--New fields-->
                </div>
            ...
            <div class="tab-pane" id="tab-server">
             ...
             <div class="tab-pane" id="tab-social">
              ...
              <div class="form-group">
                    <label class="col-sm-2 control-label" for="input-linkedin">Linkedin</label>
                    <div class="col-sm-10">
                      <input type="url" name="config_linkedin" value="<?php echo $config_linkedin; ?>" placeholder="Linkedin profile link" id="input-linkedin" class="form-control" />
                    </div>
              </div>
               <div class="form-group">
                    <label class="col-sm-2 control-label" for="input-inst">Instagram</label>
                    <div class="col-sm-10">
                      <input type="url" name="config_instagramm" value="<?php echo $config_instagramm; ?>" placeholder="Instagram profile link" id="input-inst" class="form-control" />
                    </div>
              </div>
            <div class="form-group">
                    <label class="col-sm-2 control-label" for="input-twitter">Twitter</label>
                    <div class="col-sm-10">
                      <input type="url" name="config_twitter" value="<?php echo $config_twitter; ?>" placeholder="Twitter profile link" id="input-twitter" class="form-control" />
                    </div>
            </div>
            <div class="form-group">
                    <label class="col-sm-2 control-label" for="input-face">Facebook</label>
                    <div class="col-sm-10">
                      <input type="url" name="config_facebook" value="<?php echo $config_facebook; ?>" placeholder="Facebook profile link" id="input-face" class="form-control" />
                    </div>
            </div>
            <div class="form-group">
                    <label class="col-sm-2 control-label" for="input-gp">Google +</label>
                    <div class="col-sm-10">
                      <input type="url" name="config_gplus" value="<?php echo $config_gplus; ?>" placeholder="G+ profile link" id="input-gp" class="form-control" />
                    </div>
            </div>
            <div class="form-group">
                    <label class="col-sm-2 control-label" for="input-pin">Pinterest</label>
                    <div class="col-sm-10">
                      <input type="url" name="config_pin" value="<?php echo $config_pin; ?>" placeholder="Pinterest profile link" id="input-pin" class="form-control" />
                    </div>
            </div>
<!--
              <div class="form-group">
