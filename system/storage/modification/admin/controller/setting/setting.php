...
//        новое поле
        ...
        if (isset($this->error['copyright'])) {
			$data['error_telephone'] = $this->error['copyright'];
		} else {
			$data['error_telephone'] = '';
		}
//        новое поле end
 ...
 //новое поле       
        ...
        if (isset($this->request->post['config_coryright'])) {
			$data['config_coryright'] = $this->request->post['config_coryright'];
		} else {
			$data['config_coryright'] = $this->config->get('config_coryright');
		}
        ...
        if (isset($this->request->post['config_instagramm'])) {
			$data['config_instagramm'] = $this->request->post['config_instagramm'];
		} else {
			$data['config_instagramm'] = $this->config->get('config_instagramm');
		}
        ...
        if (isset($this->request->post['config_gplus'])) {
			$data['config_gplus'] = $this->request->post['config_gplus'];
		} else {
			$data['config_gplus'] = $this->config->get('config_gplus');
		}
        if (isset($this->request->post['config_pin'])) {
			$data['config_pin'] = $this->request->post['config_pin'];
		} else {
			$data['config_pin'] = $this->config->get('config_pin');
		}
//новое поле
