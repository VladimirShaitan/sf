                        ...
                        <div class="thumb-description col-sm-4">
                            <div class="caption">
                             ...
                             <?php if ($category['ch_products']) { ?>
                                <div class="finishes-cat-block ch_cat ch_hid">
                                    <h4>Child products</h4>
                                        <ul class="list-inline multiple-cats" style="width: 320px">
...
-->
		...
		<span class="tooltip-cart"><?php echo $button_cart; ?></span>
                            ...
                            <div class="image col-sm-8">
                                <a href="<?php echo $product['href']; ?>"><img src="<?php echo $product['thumb']; ?>" alt="<?php echo empty( $product['smp_alt_images'] ) ? $product['name'] : $product['smp_alt_images']; ?>" title="<?php echo empty( $product['smp_title_images'] ) ? $product['name'] : $product['smp_title_images']; ?>" class="img-responsive" /></a>
                                <?php if ($product['special']) { ?>
