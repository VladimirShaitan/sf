            ...
            <div class="tab-pane active" id="tab-general">
              ...
              <div class="tab-content">
                ...
                <div class="tab-pane" id="language<?php echo $language['language_id']; ?>">
                  ...
                  <div class="form-group required">
                    <label class="col-sm-2 control-label" for="input-buybtnsec<?php echo $language['language_id']; ?>">Show buy button</label>
                    <div class="col-sm-10">
<!--
                      <input type="text" name="product_description[<?php echo $language['language_id']; ?>][buybtnsec]" value="<?php echo isset($product_description[$language['language_id']]) ? $product_description[$language['language_id']]['buybtnsec'] : ''; ?>" placeholder="" id="input-buybtnsec<?php echo $language['language_id']; ?>" class="form-control" />
                      
-->
<!--
                     <?php
                      echo $product_description[$language['language_id']]['buybtnsec'];
                        ?>
-->
                      <select name="product_description[<?php echo $language['language_id']; ?>][buybtnsec]" id="input-buybtnsec<?php echo $language['language_id']; ?>" class="form-control">
                          <option value="true" <?php if($product_description[$language['language_id']]['buybtnsec'] === 'true') {echo 'selected';} ?>>Show</option>
                          <option value="false" <?php if($product_description[$language['language_id']]['buybtnsec'] === 'false') {echo 'selected';} ?>>Hide</option>
                      </select>
...
-->
            ...
            <div class="tab-pane" id="tab-links">
                ...
                <div class="col-sm-10">
                  ...
                  <div id="product-category" class="well well-sm" style="height: 150px; overflow: auto;">
                    ...
                    <div id="product-category<?php echo $product_category['category_id']; ?>"><i class="fa fa-minus-circle"></i> <?php echo $product_category['name']; ?>
                      <input <?php echo $smp_url_category_id == $product_category['category_id'] ? ' checked="checked"' : ''; ?> title="<?php echo $smp_text_smp_url_category_id; ?>" style="float:left; margin: 0 5px 0 0;" type="radio" name="smp_url_category_id" value="<?php echo $product_category['category_id']; ?>" /> <input type="hidden" name="product_category[]" value="<?php echo $product_category['category_id']; ?>" />
                    </div>
                    <?php } ?>
                  </div>
                </div>
              ...
              <div class="form-group">
                <label class="col-sm-2 control-label" for="input-related"><span data-toggle="tooltip" title="<?php echo $help_related; ?>"><?php // echo $entry_related; // ?>Related Finishes</span></label>
                <div class="col-sm-10">
                  <input type="text" name="related" value="" placeholder="<?php echo $entry_related; ?>" id="input-related" class="form-control" />
                  <div id="product-related" class="well well-sm" style="height: 150px; overflow: auto;">
                    <?php foreach ($product_relateds as $product_related) { ?>
                    <div id="product-related<?php echo $product_related['product_id']; ?>"><i class="fa fa-minus-circle"></i> <?php echo $product_related['name']; ?> (id-<?php echo $product_related['product_id']; ?>)
...
<!--my related-->
              ...
              <div class="form-group">
                <label class="col-sm-2 control-label" for="input-true-related">
                <span data-toggle="tooltip" title="<?php echo $help_related; ?>"><?php echo $entry_related; ?></span></label>
                <div class="col-sm-10">
                  <input type="text" name="true-related" value="" placeholder="<?php echo $entry_related; ?>" id="input-true-related" class="form-control" />
                  <div id="product-true-related" class="well well-sm" style="height: 150px; overflow: auto;">
                    <?php foreach ($product_true_relateds as $product_true_related) { ?>
                    <div id="product-true-related<?php echo $product_true_related['product_id']; ?>"><i class="fa fa-minus-circle"></i> <?php echo $product_true_related['name']; ?> (id-<?php echo $product_true_related['product_id']; ?>)
                      <input type="hidden" name="product_true_related[]" value="<?php echo $product_true_related['product_id']; ?>" />
                    </div>
                    <?php } ?>
                  </div>
                </div>
...
$('input[name=\'category\']').autocomplete({
	...
	'select': function(item) {
		...
		$('#product-category').append('<div id="product-category' + item['value'] + '"><input type="radio" value="' + item['value'] + '" name="smp_url_category_id" style="float:left; margin: 0 5px 0 0;" title="<?php echo $smp_text_smp_url_category_id; ?>"> <i class="fa fa-minus-circle"></i> ' + item['label'] + '<input type="hidden" name="product_category[]" value="' + item['value'] + '" /></div>');
	}
});
...
// Related
$('input[name=\'true-related\']').autocomplete({
	'source': function(request, response) {
		$.ajax({
			url: 'index.php?route=catalog/product/autocomplete&token=<?php echo $token; ?>&filter_name=' +  encodeURIComponent(request),
			dataType: 'json',
	...
	'select': function(item) {
		$('input[name=\'true-related\']').val('');

		$('#product-true-related' + item['value']).remove();

		$('#product-true-related').append('<div id="product-true-related' + item['value'] + '"><i class="fa fa-minus-circle"></i> ' + item['label'] + '<input type="hidden" name="product_true_related[]" value="' + item['value'] + '" /></div>');
	}
});
...
$('#product-true-related').delegate('.fa-minus-circle', 'click', function() {
	$(this).parent().remove();
});
//--></script>
  <script type="text/javascript"><!--
