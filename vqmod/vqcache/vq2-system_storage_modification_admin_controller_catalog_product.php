...
class ControllerCatalogProduct extends Controller {
	...
	protected function getForm() {
        ...
        if (isset($this->error['buybtnsec'])) {
			$data['error_buybtnsec'] = $this->error['buybtnsec'];
		} else {
			$data['error_buybtnsec'] = array();
		}
...
//        my related
       if (isset($this->request->post['product_true_related'])) {
			$products_true = $this->request->post['product_true_related'];
		} elseif (isset($this->request->get['product_id'])) {
			$products_true = $this->model_catalog_product->getProductTrueRelated($this->request->get['product_id']);
		} else {
			$products_true = array();
		} 

		$data['product_true_relateds'] = array();

		foreach ($products_true as $product_true_id) {
			$true_related_info = $this->model_catalog_product->getProduct($product_true_id);

			if ($true_related_info) {
				$data['product_true_relateds'][] = array(
					'product_id' => $true_related_info['product_id'],
					'name'       => $true_related_info['name']
				);
			}
		}
